/*******************************************************************************
 *
 *  Copyright 2018-2019, 2025-2026 NXP
 *
...
static uint8_t ArrayOfAIDs[NUM_LS_AIDS][LEN_LS_AID] = {
    {0x12, 0x00, 0xA4, 0x04, 0x00, 0x0D, 0xA0, 0x00, 0x00, 0x03, 0x96,
     0x41, 0x4C, 0x41, 0x01, 0x4C, 0x44, 0x52, 0x01, 0x00, 0x00, 0x00},
    {0x12, 0x00, 0xA4, 0x04, 0x00, 0x0D, 0xA0, 0x00, 0x00, 0x03, 0x96,
     0x41, 0x4C, 0x41, 0x01, 0x43, 0x4F, 0x52, 0x01, 0x00, 0x00, 0x00},
...
static const char* AID_MEM_PATH[2] = {
    "/data/vendor/nfc/AID_MEM.txt", "/data/vendor/secure_element/AID_MEM.txt"};
